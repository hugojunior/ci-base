  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?=base_url();?>"><b>Ativar</b>Conta</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Digite abaixo o código que recebeu por e-mail</p>
        <form action="" method="post">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="Código de Ativação" name="login">
          ...
          <div class="row">
            ...
            <div class="col-xs-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat">Ativar</button>
            </div><!-- /.col -->
          </div>
        </form>
      </div><!-- /.login-box-body -->
